...
class CleaningLogViewer extends StatefulWidget {
  CleaningLogViewer({super.key});

  @override
  State<CleaningLogViewer> createState() => _CleaningLogViewerState();
}

class _CleaningLogViewerState extends State<CleaningLogViewer> {
        ...
        Expanded(
          child: ListView(
            ...
            children: [
              ...
              LogItemListView(jobType: "Cleaning", completionLevel: 0),
              ...
              LogItemListView(jobType: "Cleaning", completionLevel: 2),
              ...
              LogItemListView(jobType: "Cleaning", completionLevel: null, showUpcoming: true),
            ],
          )
        ),
      ],
